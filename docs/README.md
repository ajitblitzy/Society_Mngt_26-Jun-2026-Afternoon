...
- **Inline source citations** — every technical claim is followed by a
  `Source: society_mgmt_300k/...:Lx-Ly` reference (or `Source: LICENSE`)
  so it can be re-verified against the code.
...
- `society_mgmt_300k/src/controllers/file_0.js:L1-L10` — the canonical
  ...
  the archetype behind the 29-file / 33,105-function / 300,000-line
  counts.
...
- `README.md` — the repository's root readme, which links into this
