"""society_mgmt.services.file_1 — migrated layer module (canonical delegation).

The legacy module declared 1,200 byte-identical helpers (``mod_1_0`` …
``mod_1_1199``), each equal to the single canonical
