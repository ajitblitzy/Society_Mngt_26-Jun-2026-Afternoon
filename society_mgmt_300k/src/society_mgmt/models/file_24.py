"""society_mgmt.models.file_24 — migrated layer module (canonical delegation).

The legacy module declared 1,200 byte-identical helpers (``mod_24_0`` …
``mod_24_1199``), each equal to the single canonical
