...
Every module in this subpackage (``file_3``, ``file_14``, ``file_25``)
delegates to the single canonical :func:`society_mgmt.core.compute`; no
logic is re-implemented. This package initializer re-exports ``compute``
for ergonomic access (``from society_mgmt.routes import compute``).
"""
