...
- `file_4.js` → `mod_4` → ~1,200 helper functions. Source: society_mgmt_300k/src/utils/file_4.js
- `file_15.js` → `mod_15` → ~1,200 helper functions. Source: society_mgmt_300k/src/utils/file_15.js
- `file_26.js` → `mod_26` → ~1,200 helper functions. Source: society_mgmt_300k/src/utils/file_26.js
- `filler.js` → (no module id) → **0** functions — comment-only sizing padding. Source: society_mgmt_300k/src/utils/filler.js
...
- Source: society_mgmt_300k/src/utils/
