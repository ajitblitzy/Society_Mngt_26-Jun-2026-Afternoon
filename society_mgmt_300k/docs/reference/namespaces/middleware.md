...
- `file_5.js` → `mod_5` → ~1,200 helper functions. Source: society_mgmt_300k/src/middleware/file_5.js
- `file_16.js` → `mod_16` → ~1,200 helper functions. Source: society_mgmt_300k/src/middleware/file_16.js
- `file_27.js` → `mod_27` → **705** helper functions (smaller than the ~1,200 full modules). Source: society_mgmt_300k/src/middleware/file_27.js
...
- **`file_27.js` (`mod_27`) contains 705 functions, which is smaller than the ~1,200 helpers in the full modules.** Only the count differs — the bodies are still byte-identical to the canonical contract. Source: society_mgmt_300k/src/middleware/file_27.js
...
- Source: society_mgmt_300k/src/middleware/
